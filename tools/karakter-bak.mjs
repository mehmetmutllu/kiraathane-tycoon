...
const [modeller = 'Knight', cikti = 'docs/gorsel/ss/karakter-bak.png', sivil = '0', poz = '', olcekler = '', boya = '0', roller = ''] = process.argv.slice(2);
...
try {
  ...
  const url = `http://127.0.0.1:${PORT}/tools/karakter-bak.html?m=${modeller}&sivil=${sivil}&poz=${encodeURIComponent(poz)}&olcekler=${olcekler}&boya=${boya}&roller=${roller}`;
