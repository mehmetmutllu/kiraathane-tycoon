...
const NOKTA: Record<string, DonmusNokta> = {
  ...
  'pad.alan3': { deger: [0.0, 1.2], karar: 'T7/D-141 (G-82: kapı ekseni + eşik; eski 2,0 · 1,8 masa 6 çerçevesine giriyordu)', canli: () => xz(LAYOUT.padPos.zone3) },
  'pad.garson2': { deger: [-10.5, 9.75], karar: 'T8a/D-142 (2. garson Salon 1 sonuna taşındı; eski −14,7 · −5,0 Salon 3 bandıydı, kapalı salonda yürünemezdi)', canli: () => xz(LAYOUT.padPos.waiter2) },
